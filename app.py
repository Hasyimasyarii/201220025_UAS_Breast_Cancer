...
st.title('Aplikasi Gejala Kanker Payudara')

html_layout1 = """
<br>
<div style="background-color:red ; padding:2px">
<h2 style="color:white;text-align:center;font-size:35px"><b>Kanker Payudara Checkup</b></h2>
</div>
<br>
<br>
"""
...
option = st.sidebar.selectbox('Pilihan Model',activities)
...
def user_report():
  radius_mean = st.sidebar.slider('radius_mean: ', 0.0, 28.11000, 16.0)
  area_mean = st.sidebar.slider('area_mean: ', 0.0, 2501.0, 16.0)
  radius_se = st.sidebar.slider('radius_se: ', 0.0, 2.87300, 1.9)
  area_se = st.sidebar.slider('area_se: ', 0.0, 542.20, 100.0)
  smoothness_mean = st.sidebar.slider('smoothness_mean: ', 0.0, 0.16340, 0.14)
  smoothness_se = st.sidebar.slider('smoothness_se: ', 0.0, 0.03113, 0.02)
